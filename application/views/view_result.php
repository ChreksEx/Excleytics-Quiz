...
<?php echo $this->lang->line('hello'); ?> <?php echo $result['first_name']; ?>
                            <?php echo $result['last_name']; ?>!</span> <?php echo str_replace('{attempt_no}', ordinal($attempt), $this->lang->line('title_result')); ?>
                    </h3></center>
            </div>
            <div class="col-lg-12">
                <center>
            ...
            <?php if(count($letters_counts) > 0) { ?>
                <div class="row">
                    <div class="col-lg-12">
                        <center><h2><span style="color:#e39500;"> Letters with the most responses </span></h2></center>
                    </div>
                    <?php foreach ($letters_counts as $letter => $qtt) { ?>
                        <div class="col-lg-2" style="text-align:center;">
                            <p> <?= strtoupper($letter); ?> </p>
                            <p style="color:#e39500;"> <?= $qtt; ?> </p>
                        </div>
                    <?php } ?>
                </div>
            <?php } ?>
                            ...
                            <div class='animatedimage'>
                                ...
                                foreach ($files2 as $j => $file) {
                                    ...
                                    <img src='<?php echo base_url($file); ?>'
                                         style="width:600px;height:300px;" <?php if ($j == 0) {
                                        echo "class='poster'";
                                    } ?> >
                                    <!-- <b><?php echo $fname[2] . '-' . $fname[3] . '-' . $fname[4] . '-' . $fname[5] . '-' . $fname[6] . '-' . $fname[7]; ?></b> -->
            ...
            <div class="col-md-12">
                ...
                <center><?php
                    ...
                    if ($query->num_rows() == 1) {
                        ...
                        } else if ($ad['banner'] != '') { ?><a href="<?php echo $ad['banner_link']; ?>"target="new_add">
                            <img src="<?php echo base_url('upload/' . $ad['banner']); ?>" class="img-responsive">
                            </a> <?php
                        }
                    }
                    ?></center>
                    ...
                    if ($result['view_answer'] == '1' || $logged_in['su'] == '1') {
                        ...
                        <div class="login-panel panel panel-default noprint">
                            <div class="panel-body">
                                ...
                                <?php
                                $abc = array('0' => 'A', '1' => 'B', '2' => 'C', '3' => 'D', '4' => 'E', '6' => 'F', '7' => 'G', '8' => 'H', '9' => 'I', '10' => 'J', '11' => 'K');
                                    ...
                                    <div class="rqn" id="qn<?php echo $qk; ?>" style=" <?php if ($qk == 0) {
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 " id="q<?php echo $qk; ?>" class=""
                                                 style="margin:10px;padding:10px;<?php if ($ind_score[$qk] == '1') { ?>background-color:#71ba5d; color:#ffffff;<?php
                                                 } else if ($ind_score[$qk] == '2') { ?>background-color:#ff5e5e; color:#ffffff;<?php
                                                 } else if ($ind_score[$qk] == '3') { ?>background-color:#fdfbcf;<?php
                                                 } else { ?>background-color:#ffffff;<?php
                                                 } ?>">
                                                <div class="col-md-2 col-sm-2">
                                                    <div style="height:45px; width:45px; background-color:#ffffff;border-radius:50%;color:#4b7d42;
            margin-top:6px;padding:11px; text-align: center; border:1px solid #666666;"><b><?php echo $qk + 1; ?></b></div>
                                                </div>
                                                <div class="col-md-8 col-sm-8">
                                                    ...
                                                    // select_letters
                                                    if ($question['question_type'] == $this->lang->line('select_letters')) {
                                                        ...
                                                        foreach ($options as $ok => $option) {
                                                            if ($option['qid'] == $question['qid']) {
                                                                ...
                                                                ?>
                                                                <?php if (in_array($option['oid'], $save_ans)) {
                                                                    echo '<b>' . $this->lang->line('your_letter') . ':</b>' . '<br>' . strtoupper($option['q_option_match']);
                                                                    echo '<br><br>';
                                                                    echo '<b>' . $this->lang->line('your_answer') . '</b>:' . $option['q_option'];
                                                                } ?>
                                                                <?php
                                                ...
                                                <div class="col-md-2 col-sm-2" id="q<?php echo $qk; ?>"
                                                     style="font-size:30px;">

                                                    <?php if ($ind_score[$qk] == '1') { ?><i
                                                            class="glyphicon glyphicon-ok"></i>  <?php
                                                    } else if ($ind_score[$qk] == '2') { ?>
                                ...
                                foreach ($questions as $qk => $question) {
                                    ?>
                                    <a href="javascript:shoq('<?php echo $qk; ?>');"
                                       class="btn btn-default"><?php echo $qk + 1; ?></a>
                                    <?php
                                }
                                ?>
                                <a href="javascript:shoq('-1');"
                                   class="btn btn-default"><?php echo $this->lang->line('view_all'); ?></a>
                            </div>
                        </div>
                        <?php
                    }
