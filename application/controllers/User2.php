...
class User2 extends CI_Controller
{
    ...
    public function view_user($uid)
    {
        ...
        $data['custom_fields'] = $this->db->query("select * from savsoft_users_custom uc " .
            "left join savsoftquiz_custom_form cf on uc.field_id = cf.field_id where uc.uid = $uid")->result_array();
