...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-2">
            <a href="/users" class="pull-right"><img title="profile image" class="img-circle img-responsive" src="http://www.gravatar.com/avatar/<?php echo md5($result['email']); ?>?s=100"></a>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-3"><!--left col-->
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item text-right">
                    <span class="pull-left"><strong><?php echo $this->lang->line('joined'); ?></strong></span> <?php echo $result['registered_date']; ?>
                </li>
                <li class="list-group-item text-right">
                    <span class="pull-left"><strong><?php echo $this->lang->line('group_name'); ?></strong></span> <?php echo $result['group_name']; ?>
                </li>
                <li class="list-group-item text-right">
                    <span class="pull-left"><strong><?php echo $this->lang->line('account_type'); ?></strong></span> <?php if ($result['su'] == 1) {
            ...
            <div class="card shadow custom">
                <div class="card-heading" style="padding:5px;">Custom fields:</div>
                <?php foreach ($custom_fields as $custom_field) { ?>
                    <div class="card-body"><b><?= $custom_field['field_title']; ?>:</b> <?= $custom_field['field_values']; ?> </div>
                <?php } ?>
            </div>
            <?php } ?>
            ...
            <ul class="list-group">
                <li class="list-group-item text-muted"><?php echo $this->lang->line('activity'); ?>
                    <i class="fa fa-dashboard fa-1x"></i></li>
                <li class="list-group-item text-right">
                    <span class="pull-left"><strong><?php echo $this->lang->line('quiz_attempted'); ?></strong></span> <?php echo $attempted; ?>
                </li>
                <li class="list-group-item text-right">
                    <span class="pull-left"><strong><?php echo $this->lang->line('pass'); ?></strong></span> <?php echo $pass; ?>
                </li>
                <li class="list-group-item text-right">
                    <span class="pull-left"><strong><?php echo $this->lang->line('fail'); ?></strong></span> <?php echo $fail; ?>
                </li>
                <li class="list-group-item text-right">
                    <span class="pull-left"><strong><?php echo $this->lang->line('last_attempt'); ?></strong></span> <?php echo $lastattempt; ?>
                </li>
            </ul>
                ...
                <table class="table table-striped">
                    ...
                    foreach ($questions as $k => $qv) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" data-toggle="modal" data-target="#myModal<?php echo $qv['qid']; ?>"><i class="fa fa-eye" title="View Question"></i></a>
                            </td>
