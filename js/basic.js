...
function hidenop(_this){
	console.log(_this);

	if(_this.val() == '1' || _this.val()=='2' || _this.val()=='3' || _this.val()=='6'){
	...
	if(_this.val() == '6'){
		$(_this).closest('.panel-body').find('#nop input').attr('value', 2);
	} else {
		$(_this).closest('.panel-body').find('#nop input').attr('value', 4);
	}
}
