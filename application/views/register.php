<div class="row" style="border-bottom:1px solid #dddddd;">
    <div class="container">
        ...
        <div class="col-md-10">
            <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url('images/logo_50.png'); ?>"></a>
                    ...
                    <div class="panel-body">
                        ...
                        if ($token) {
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="inputEmail" name="email" class="form-control" value="<?= $email; ?>"
...
<!--                                            (--><?php //echo $this->lang->line('price_'); ?><!--: --><?php //echo $val['price']; ?><!--)-->
<!--                                        </option>-->
<!--                                        --><?php
//                                    }
//                                    ?>
...
<!--                            </div>-->
                            ...
                            foreach ($custom_form as $fk => $fval) {
                                ...
                                ?>
                                <div class="form-group">
                                    <label for="custom[<?php echo $fval['field_id']; ?>]" class="sr-only"><?php echo $fval['field_title']; ?></label>
                                    <?php if ($fval['field_type'] == 'select') { ?>
                                        <select name="custom[<?php echo $fval['field_id']; ?>]" class="form-control">
                                            <?php foreach (explode(' | ', $fval['options']) as $option) { ?>
                                    ...
                                    <?php } else { ?>
                                        <input type="<?php echo $fval['field_type']; ?>" name="custom[<?php echo $fval['field_id']; ?>]" class="form-control" value="<?php echo $fval['field_value']; ?>" <?php echo $fval['field_validate']; ?>
                                               placeholder="<?php echo $fval['field_title']; ?>" autofocus>
                                    <?php } ?>
                                </div>
