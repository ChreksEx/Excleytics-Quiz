        ...
        <form method="post" action="<?php echo site_url('user/edit_custom/' . $custom['field_id']); ?>">
            ...
            <div class="form-group">
                ...
                <select name="field_type" class="form-control">
                    <option value="text" <?php if ($custom['field_type'] == 'text') {
                        echo 'selected';
                    } ?> >Text
                    </option>
                    <option value="password" <?php if ($custom['field_type'] == 'password') {
                        echo 'selected';
                    } ?> >Password
                    </option>
                    <option value="select" <?php if ($custom['field_type'] == 'select') {
                        echo 'selected';
                    } ?> >List
                    </option>
                </select>
            ...
            <div class="form-group">
                ...
                <select name="display_at" class="form-control">
                    <option value="Registration" <?php if ($custom['display_at'] == 'Registration') {
                        echo 'selected';
                    } ?> >Registration
                    </option>
                    <option value="Result" <?php if ($custom['display_at'] == 'Result') {
                        echo 'selected';
            ...
            <div class="form-group">
                ...
                <input type="text" name="options" class="form-control" placeholder="Option 1 | Option 2 | etc."
